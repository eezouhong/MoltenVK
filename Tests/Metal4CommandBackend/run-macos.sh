...
grep -Eq 'Metal 4 command backend summary: .*fallbacks=1, failures=0' "${BUILD_DIR}/metal4.log"
...
grep -Eq 'Metal 4 command backend summary: .*fallbacks=1, failures=0' "${BUILD_DIR}/metal4-single-queue.log"
